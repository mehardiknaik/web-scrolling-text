...
const SvgComponent = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <style>
      {
        "@keyframes eWSLi8rbaTl2_s_do{0%{stroke-dashoffset:0}to{stroke-dashoffset:300}}@keyframes eWSLi8rbaTl3_s_do{0%{stroke-dashoffset:0}to{stroke-dashoffset:360}}@keyframes eWSLi8rbaTl4_s_do{0%{stroke-dashoffset:0}to{stroke-dashoffset:500}}@keyframes eWSLi8rbaTl5_s_do{0%{stroke-dashoffset:0}to{stroke-dashoffset:360}}"
      }
    </style>
    <defs>
      <linearGradient
        ...
        spreadMethod="pad"
      >
        <stop id="eWSLi8rbaTl2-stroke-0" offset="0%" stopColor="#0036a4" />
        <stop id="eWSLi8rbaTl2-stroke-1" offset="49%" stopColor="#6a2364" />
        <stop id="eWSLi8rbaTl2-stroke-2" offset="100%" stopColor="#4cceff" />
      </linearGradient>
      <linearGradient
        ...
        spreadMethod="pad"
      >
        <stop id="eWSLi8rbaTl3-stroke-0" offset="0%" stopColor="#fff" />
        <stop id="eWSLi8rbaTl3-stroke-1" offset="48%" stopColor="#359fad" />
        <stop id="eWSLi8rbaTl3-stroke-2" offset="100%" stopColor="#fff" />
      </linearGradient>
      <linearGradient
        ...
        spreadMethod="pad"
      >
        <stop id="eWSLi8rbaTl4-stroke-0" offset="0%" stopColor="#ae3bd4" />
        <stop id="eWSLi8rbaTl4-stroke-1" offset="48%" stopColor="#2bc4c3" />
        <stop id="eWSLi8rbaTl4-stroke-2" offset="100%" stopColor="#ff00f6" />
      </linearGradient>
      <radialGradient
      ...
      >
        <stop
          ...
          offset="0%"
          stopColor="rgba(34,56,133,0.52)"
        />
        <stop
          id="eWSLi8rbaTl5-stroke-1"
          offset="100%"
          stopColor="rgba(255,176,195,0.77)"
        />
      </radialGradient>
    </defs>
    <path
